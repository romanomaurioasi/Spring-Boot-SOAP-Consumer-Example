...
import ch.swissdec.schema.id._20180901.incidentdeclaration.AccidentStaffType;
 ...
 * 
 * 
 * <p>Classe Java per IncidentStateType complex type.
 * 
 ...
 *         &lt;element name="Staff" type="{http://www.swissdec.ch/schema/id/20180901/IncidentDeclaration}AccidentStaffType"/&gt;
...
@XmlType(name = "IncidentStateType", propOrder = {
    "addresseeContext",
    "institutionAddress",
    "digitalizationScope",
    "staff",
...
public class IncidentStateType {
    ...
    protected AccidentStaffType staff;
     ...
     * @return
     *     possible object is
     *     {@link AccidentStaffType }
     *     
     */
    public AccidentStaffType getStaff() {
        return staff;
    }
     ...
     *     
     */
    public void setStaff(AccidentStaffType value) {
        this.staff = value;
    }
