 ...
 * 
 * 
 * <p>Classe Java per KTG-AMC-WorkingStateType complex type.
 * 
 * <p>Il seguente frammento di schema specifica il contenuto previsto contenuto in questa classe.
 * 
 * <pre>
 * &lt;complexType name="KTG-AMC-WorkingStateType"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;choice&gt;
 *         &lt;element name="Success" type="{http://www.swissdec.ch/schema/id/20180901/IncidentDeclarationContainer}KTG-AMC-IncidentStateType"/&gt;
...
@XmlType(name = "KTG-AMC-WorkingStateType", propOrder = {
    "success",
    "ignored",
    "error"
})
@XmlSeeAlso({
    ReducedKTGAMCWorkingStateType.class
})
public class KTGAMCWorkingStateType {

    @XmlElement(name = "Success")
    protected KTGAMCIncidentStateType success;
     ...
     * @return
     *     possible object is
     *     {@link KTGAMCIncidentStateType }
     *     
     */
    public KTGAMCIncidentStateType getSuccess() {
        return success;
    }
     ...
     *     
     */
    public void setSuccess(KTGAMCIncidentStateType value) {
        this.success = value;
    }
