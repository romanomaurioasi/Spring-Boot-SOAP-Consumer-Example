 ...
 *       &lt;sequence&gt;
 *         &lt;element name="TotalMonth" type="{http://www.swissdec.ch/schema/sd/20130514/SalaryDeclaration}TaxAtSourceTotalsMonthType"/&gt;
 *         &lt;element name="CorrectionMonth" type="{http://www.swissdec.ch/schema/sd/20130514/SalaryDeclaration}TaxAtSourceTotalsCorrectionMonthType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="TotalYear" type="{http://www.swissdec.ch/schema/sd/20130514/SalaryDeclaration}TaxAtSourceTotalsPeriodType"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class TaxAtSourceTotalsConsumerType {
    ...
    @XmlElement(name = "TotalYear", required = true)
    protected TaxAtSourceTotalsPeriodType totalYear;
    ...
    /**
     * Recupera il valore della proprietà totalYear.
     * 
     * @return
     *     possible object is
     *     {@link TaxAtSourceTotalsPeriodType }
     *     
     */
    public TaxAtSourceTotalsPeriodType getTotalYear() {
        return totalYear;
    }

    /**
     * Imposta il valore della proprietà totalYear.
     * 
     * @param value
     *     allowed object is
     *     {@link TaxAtSourceTotalsPeriodType }
     *     
     */
    public void setTotalYear(TaxAtSourceTotalsPeriodType value) {
        this.totalYear = value;
    }
