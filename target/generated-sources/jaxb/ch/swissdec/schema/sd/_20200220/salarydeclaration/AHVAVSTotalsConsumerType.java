 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Total-AHV-AVS-Incomes" type="{http://www.swissdec.ch/schema/common/20200220/Common}SalaryAmountType"/&gt;
 *         &lt;element name="Total-AHV-AVS-Open" type="{http://www.swissdec.ch/schema/common/20200220/Common}SalaryAmountType"/&gt;
 *         &lt;element name="Total-ALV-AC-Incomes" type="{http://www.swissdec.ch/schema/common/20200220/Common}SalaryAmountType"/&gt;
 *         &lt;element name="Total-ALVZ-ACS-Incomes" type="{http://www.swissdec.ch/schema/common/20200220/Common}SalaryAmountType"/&gt;
 *         &lt;element name="Total-ALV-AC-Open" type="{http://www.swissdec.ch/schema/common/20200220/Common}SalaryAmountType"/&gt;
 *         &lt;element name="Total-FLG-LFA-Incomes" type="{http://www.swissdec.ch/schema/common/20200220/Common}SalaryAmountType" minOccurs="0"/&gt;
 *         &lt;element name="Total-FLG-LFA-FamilyIncome-Supplement" type="{http://www.swissdec.ch/schema/common/20200220/Common}SalaryAmountType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "AHV-AVS-TotalsConsumerType", propOrder = {
    ...
    "totalALVACOpen",
    "totalFLGLFAIncomes",
    "totalFLGLFAFamilyIncomeSupplement"
})
@XmlSeeAlso({
...
public class AHVAVSTotalsConsumerType {
    ...
    @XmlElement(name = "Total-FLG-LFA-FamilyIncome-Supplement")
    protected BigDecimal totalFLGLFAFamilyIncomeSupplement;
    ...
    /**
     * Recupera il valore della proprietà totalFLGLFAFamilyIncomeSupplement.
     * 
     * @return
     *     possible object is
     *     {@link BigDecimal }
     *     
     */
    public BigDecimal getTotalFLGLFAFamilyIncomeSupplement() {
        return totalFLGLFAFamilyIncomeSupplement;
    }

    /**
     * Imposta il valore della proprietà totalFLGLFAFamilyIncomeSupplement.
     * 
     * @param value
     *     allowed object is
     *     {@link BigDecimal }
     *     
     */
    public void setTotalFLGLFAFamilyIncomeSupplement(BigDecimal value) {
        this.totalFLGLFAFamilyIncomeSupplement = value;
    }
