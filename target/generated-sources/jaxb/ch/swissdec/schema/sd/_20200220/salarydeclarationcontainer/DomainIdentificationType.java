...
import ch.swissdec.schema.sd._20200220.salarydeclaration.BVGLPPIdentificationType;
import ch.swissdec.schema.sd._20200220.salarydeclaration.FAKCAFIdentificationType;
import ch.swissdec.schema.sd._20200220.salarydeclaration.KTGAMCIdentificationType;
import ch.swissdec.schema.sd._20200220.salarydeclaration.RequestIdentificationBaseType;
import ch.swissdec.schema.sd._20200220.salarydeclaration.TaxAtSourceIdentificationType;
import ch.swissdec.schema.sd._20200220.salarydeclaration.TaxIdentificationType;
import ch.swissdec.schema.sd._20200220.salarydeclaration.UVGLAAIdentificationType;
import ch.swissdec.schema.sd._20200220.salarydeclaration.UVGZLAACIdentificationType;
 ...
 *         &lt;element name="UVG-LAA-Identification" type="{http://www.swissdec.ch/schema/sd/20200220/SalaryDeclaration}UVG-LAA-IdentificationType"/&gt;
 *         &lt;element name="UVGZ-LAAC-Identification" type="{http://www.swissdec.ch/schema/sd/20200220/SalaryDeclaration}UVGZ-LAAC-IdentificationType"/&gt;
 *         &lt;element name="KTG-AMC-Identification" type="{http://www.swissdec.ch/schema/sd/20200220/SalaryDeclaration}KTG-AMC-IdentificationType"/&gt;
 *         &lt;element name="BVG-LPP-Identification" type="{http://www.swissdec.ch/schema/sd/20200220/SalaryDeclaration}BVG-LPP-IdentificationType"/&gt;
 *         &lt;element name="TaxIdentification" type="{http://www.swissdec.ch/schema/sd/20200220/SalaryDeclaration}TaxIdentificationType"/&gt;
 *         &lt;element name="TaxAtSourceIdentification" type="{http://www.swissdec.ch/schema/sd/20200220/SalaryDeclaration}TaxAtSourceIdentificationType"/&gt;
 *         &lt;element name="TaxCrossborderIdentification" type="{http://www.swissdec.ch/schema/sd/20200220/SalaryDeclaration}TaxAtSourceIdentificationType"/&gt;
 *         &lt;element name="StatisticIdentification" type="{http://www.swissdec.ch/schema/sd/20200220/SalaryDeclaration}RequestIdentificationBaseType"/&gt;
 *       &lt;/choice&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class DomainIdentificationType {
    ...
    @XmlElement(name = "TaxCrossborderIdentification")
    protected TaxAtSourceIdentificationType taxCrossborderIdentification;
    ...
    /**
     * Recupera il valore della proprietà taxCrossborderIdentification.
     * 
     * @return
     *     possible object is
     *     {@link TaxAtSourceIdentificationType }
     *     
     */
    public TaxAtSourceIdentificationType getTaxCrossborderIdentification() {
        return taxCrossborderIdentification;
    }

    /**
     * Imposta il valore della proprietà taxCrossborderIdentification.
     * 
     * @param value
     *     allowed object is
     *     {@link TaxAtSourceIdentificationType }
     *     
     */
    public void setTaxCrossborderIdentification(TaxAtSourceIdentificationType value) {
        this.taxCrossborderIdentification = value;
    }
