 ...
 *         &lt;element name="NumberOf-OwnershipRightDetail-Tags" type="{http://www.w3.org/2001/XMLSchema}unsignedInt" minOccurs="0"/&gt;
 *         &lt;element name="NumberOf-TaxAtSourceSalary-Tags" type="{http://www.w3.org/2001/XMLSchema}unsignedInt" minOccurs="0"/&gt;
 *         &lt;element name="NumberOf-TaxCrossborderSalary-Tags" type="{http://www.w3.org/2001/XMLSchema}unsignedInt" minOccurs="0"/&gt;
...
@XmlType(name = "SalaryCountersType", propOrder = {
    ...
    "numberOfOwnershipRightDetailTags",
    "numberOfTaxAtSourceSalaryTags",
    "numberOfTaxCrossborderSalaryTags",
...
public class SalaryCountersType {
    ...
    @XmlElement(name = "NumberOf-OwnershipRightDetail-Tags")
    @XmlSchemaType(name = "unsignedInt")
    protected Long numberOfOwnershipRightDetailTags;
    @XmlElement(name = "NumberOf-TaxAtSourceSalary-Tags")
    @XmlSchemaType(name = "unsignedInt")
    protected Long numberOfTaxAtSourceSalaryTags;
    @XmlElement(name = "NumberOf-TaxCrossborderSalary-Tags")
    @XmlSchemaType(name = "unsignedInt")
    protected Long numberOfTaxCrossborderSalaryTags;
    ...
    /**
     * Recupera il valore della proprietà numberOfOwnershipRightDetailTags.
     * 
     * @return
     *     possible object is
     *     {@link Long }
     *     
     */
    public Long getNumberOfOwnershipRightDetailTags() {
        return numberOfOwnershipRightDetailTags;
    }

    /**
     * Imposta il valore della proprietà numberOfOwnershipRightDetailTags.
     * 
     * @param value
     *     allowed object is
     *     {@link Long }
     *     
     */
    public void setNumberOfOwnershipRightDetailTags(Long value) {
        this.numberOfOwnershipRightDetailTags = value;
    }
    ...
    /**
     * Recupera il valore della proprietà numberOfTaxCrossborderSalaryTags.
     * 
     * @return
     *     possible object is
     *     {@link Long }
     *     
     */
    public Long getNumberOfTaxCrossborderSalaryTags() {
        return numberOfTaxCrossborderSalaryTags;
    }

    /**
     * Imposta il valore della proprietà numberOfTaxCrossborderSalaryTags.
     * 
     * @param value
     *     allowed object is
     *     {@link Long }
     *     
     */
    public void setNumberOfTaxCrossborderSalaryTags(Long value) {
        this.numberOfTaxCrossborderSalaryTags = value;
    }
