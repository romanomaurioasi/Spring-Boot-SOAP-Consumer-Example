...
/**
 * <p>Classe Java per TaxCrossborderSalaryResultType complex type.
 * 
 * <p>Il seguente frammento di schema specifica il contenuto previsto contenuto in questa classe.
 * 
 * <pre>
 * &lt;complexType name="TaxCrossborderSalaryResultType"&gt;
 *   &lt;complexContent&gt;
 ...
 *           &lt;element name="CompletionReleaseIsMissing" type="{http://www.swissdec.ch/schema/sd/20200220/SalaryDeclarationContainer}TaxAtSourceMinimalResultStateType"/&gt;
 ...
 *           &lt;element name="Success" type="{http://www.swissdec.ch/schema/sd/20200220/SalaryDeclarationContainer}TaxCrossborderResultSuccessType"/&gt;
 *         &lt;/choice&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
...
@XmlType(name = "TaxCrossborderSalaryResultType", propOrder = {
    "warning",
    "info",
    "notSupported",
...
@XmlSeeAlso({
    TaxCrossborderReducedSalaryResultType.class
})
public class TaxCrossborderSalaryResultType {
    ...
    protected TaxAtSourceMinimalResultStateType completionReleaseIsMissing;
    @XmlElement(name = "Processing")
    protected TaxAtSourceProcessingType processing;
    @XmlElement(name = "Error")
    protected ErrorResponseType error;
    @XmlElement(name = "Success")
    protected TaxCrossborderResultSuccessType success;
     ...
     *     
     */
    public TaxAtSourceMinimalResultStateType getCompletionReleaseIsMissing() {
     ...
     *     
     */
    public void setCompletionReleaseIsMissing(TaxAtSourceMinimalResultStateType value) {
     ...
     * @return
     *     possible object is
     *     {@link TaxCrossborderResultSuccessType }
     *     
     */
    public TaxCrossborderResultSuccessType getSuccess() {
        return success;
    }
     ...
     *     
     */
    public void setSuccess(TaxCrossborderResultSuccessType value) {
        this.success = value;
    }
